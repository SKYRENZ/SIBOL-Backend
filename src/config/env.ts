...
export const config = {
  ...
  FRONT_END_PORT: getOptionalEnv('FRONT_END_PORT', 'https://sibol-frontend.vercel.app'),

  // Comma-separated list of allowed frontend origins (for dev + prod)
  FRONT_END_ORIGINS: getOptionalEnv('FRONT_END_ORIGINS', 'http://localhost:5173,https://sibol-frontend.vercel.app'),
